...
class MyAttractionsPage extends StatefulWidget {
  const MyAttractionsPage({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  State<MyAttractionsPage> createState() => _MyAttractionsPageState();
}

class _MyAttractionsPageState extends State<MyAttractionsPage> {
...
void main() {
  runApp(const MaterialApp(
    home: MyAttractionsPage(title: 'Bottom Navigation Bar Demo'),
  ));
}
