...
class MyLandmarkPage extends StatefulWidget {
  const MyLandmarkPage({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  State<MyLandmarkPage> createState() => _MyLandmarkPageState();
}

class _MyLandmarkPageState extends State<MyLandmarkPage> {
...
void main() {
  runApp(const MaterialApp(
    home: MyLandmarkPage(title: 'Bottom Navigation Bar Demo'),
  ));
}
