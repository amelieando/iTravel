...
class MyHiddenGemsPage extends StatefulWidget {
  const MyHiddenGemsPage({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  State<MyHiddenGemsPage> createState() => _MyHiddenGemsPageState();
}

class _MyHiddenGemsPageState extends State<MyHiddenGemsPage> {
...
void main() {
  runApp(const MaterialApp(
    home: MyHiddenGemsPage(title: 'Bottom Navigation Bar Demo'),
  ));
}
